...
var app = (function () {
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$5, 40, 32, 1428);

    			attr_dev(li, "class", li_class_value = /*item*/ ctx[4].name == /*title*/ ctx[1]
    			? "bordered"
    			: "");

    			add_location(li, file$5, 39, 28, 1345);
    		},
    ...
    function create_if_block_1$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a.textContent = "Esci";
    			attr_dev(a, "href", "/");
    			add_location(a, file$5, 46, 32, 1645);
    			add_location(li, file$5, 45, 28, 1607);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    			append_dev(li, a);
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$5, 81, 20, 2950);
    			attr_dev(li, "class", "active");
    			add_location(li, file$5, 80, 16, 2909);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    			append_dev(li, a);
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$5, 91, 20, 3360);
    			attr_dev(li, "class", "active");
    			add_location(li, file$5, 90, 16, 3319);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    			append_dev(li, a);
    ...
    function create_fragment$7(ctx) {
    	...
    	let if_block0 = /*$token*/ ctx[2] != "" && create_if_block_1$2(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			if (!src_url_equal(img.src, img_src_value = "/logonuvolaris.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Logo");
    			attr_dev(img, "class", "h-8 w-auto mr-2");
    			add_location(img, file$5, 26, 24, 800);
    			attr_dev(a, "href", "/");
    			attr_dev(a, "class", "flex items-center py-4 px-2");
    			add_location(a, file$5, 25, 20, 726);
    			add_location(div0, file$5, 23, 16, 656);
    			attr_dev(ul0, "class", "menu items-stretch px-3 shadow-lg bg-base-100 horizontal rounded-box");
    			add_location(ul0, file$5, 35, 20, 1141);
    			attr_dev(div1, "class", "hidden md:flex items-center space-x-1");
    			add_location(div1, file$5, 34, 16, 1068);
    			attr_dev(div2, "class", "flex space-x-7");
    			add_location(div2, file$5, 22, 12, 610);
    			attr_dev(path, "d", "M4 6h16M4 12h16M4 18h16");
    			add_location(path, file$5, 70, 24, 2631);
    			...
    			add_location(svg, file$5, 60, 20, 2188);
    			attr_dev(button, "class", "outline-none mobile-menu-button");
    			add_location(button, file$5, 59, 16, 2118);
    			attr_dev(div3, "class", "md:hidden flex items-center");
    			add_location(div3, file$5, 58, 12, 2059);
    			attr_dev(div4, "class", "flex justify-between");
    			add_location(div4, file$5, 21, 8, 562);
    			attr_dev(div5, "class", "max-w-6xl mx-auto px-4");
    			add_location(div5, file$5, 20, 4, 516);
    			attr_dev(ul1, "class", "");
    			add_location(ul1, file$5, 78, 8, 2844);
    			attr_dev(div6, "class", "hidden mobile-menu");
    			add_location(div6, file$5, 77, 4, 2802);
    			attr_dev(nav, "class", "bg-white shadow-lg");
    			add_location(nav, file$5, 19, 0, 478);
    		},
    ...
    class Menu extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$7, create_fragment$7, safe_not_equal, { menu: 0, title: 1 });
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option, file$4, 82, 18, 2597);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(82:16) {#each roles as roleins}",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 67, 4, 2058);
    			attr_dev(label0, "for", "inputRole");
    			attr_dev(label0, "class", "small mb-1");
    			add_location(label0, file$4, 72, 14, 2197);
    			attr_dev(legend, "class", "sr-only");
    			add_location(legend, file$4, 74, 14, 2275);
    			add_location(br0, file$4, 74, 53, 2314);
    			...
    			add_location(select, file$4, 75, 14, 2336);
    			attr_dev(th0, "colspan", "2");
    			add_location(th0, file$4, 71, 12, 2164);
    			add_location(tr0, file$4, 70, 10, 2146);
    			attr_dev(label1, "for", "exampleEmail");
    			attr_dev(label1, "class", "small mb-1");
    			add_location(label1, file$4, 91, 14, 2827);
    			...
    			add_location(input0, file$4, 92, 14, 2902);
    			attr_dev(div0, "class", "col-sm-5 messages");
    			add_location(div0, file$4, 100, 14, 3191);
    			attr_dev(th1, "colspan", "2");
    			add_location(th1, file$4, 90, 12, 2797);
    			add_location(tr1, file$4, 89, 10, 2779);
    			attr_dev(label2, "for", "inputPassword");
    			attr_dev(label2, "class", "small mb-1");
    			add_location(label2, file$4, 105, 14, 3342);
    			...
    			add_location(input1, file$4, 106, 14, 3421);
    			attr_dev(div1, "class", "col-sm-5 messages");
    			add_location(div1, file$4, 114, 14, 3728);
    			add_location(th2, file$4, 104, 12, 3322);
    			attr_dev(label3, "for", "inputConfirmPassword");
    			attr_dev(label3, "class", "small mb-1");
    			add_location(label3, file$4, 118, 14, 3860);
    			...
    			add_location(input2, file$4, 121, 14, 3988);
    			attr_dev(div2, "class", "col-sm-5 messages");
    			add_location(div2, file$4, 128, 14, 4266);
    			add_location(th3, file$4, 116, 12, 3825);
    			add_location(tr2, file$4, 103, 12, 3304);
    			attr_dev(label4, "for", "inputFirstName");
    			attr_dev(label4, "class", "small mb-1");
    			add_location(label4, file$4, 135, 14, 4453);
    			...
    			add_location(input3, file$4, 136, 14, 4528);
    			add_location(th4, file$4, 134, 12, 4433);
    			attr_dev(label5, "for", "inputLastName");
    			attr_dev(label5, "class", "small mb-1");
    			add_location(label5, file$4, 148, 14, 4881);
    			...
    			add_location(input4, file$4, 149, 14, 4958);
    			add_location(th5, file$4, 147, 12, 4861);
    			add_location(tr3, file$4, 132, 10, 4401);
    			attr_dev(label6, "for", "inputAddress");
    			attr_dev(label6, "class", "small mb-1");
    			add_location(label6, file$4, 162, 14, 5340);
    			...
    			add_location(input5, file$4, 163, 14, 5416);
    			add_location(th6, file$4, 161, 12, 5320);
    			attr_dev(label7, "for", "inputPhone");
    			attr_dev(label7, "class", "small mb-1");
    			add_location(label7, file$4, 173, 14, 5749);
    			...
    			add_location(input6, file$4, 174, 14, 5821);
    			add_location(th7, file$4, 172, 12, 5729);
    			add_location(tr4, file$4, 160, 10, 5302);
    			attr_dev(table, "class", "table-fixed");
    			add_location(table, file$4, 69, 8, 2107);
    			add_location(br1, file$4, 187, 20, 6197);
    			attr_dev(button, "class", "btn btn-accent");
    			attr_dev(button, "href", "pages/authentication/login");
    			add_location(button, file$4, 189, 8, 6221);
    			attr_dev(form_1, "id", "main");
    			add_location(form_1, file$4, 68, 4, 2081);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	let data = {
    		role: "User", /*,name: "",surname:"",address:"",phone:"",email:"",password:""*/
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$3, 9, 4, 257);
    			attr_dev(div1, "class", "flex flex-col md:flex-row");
    			add_location(div1, file$3, 8, 0, 212);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Layout extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { page: 0, menu: 1, title: 2, hideTitle: 3 });
    ...
    /* src\Input.svelte generated by Svelte v3.44.2 */
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			br = element("br");
    			attr_dev(input, "class", "rounded-md focus:ring-2 focus:ring-blue-500 text-center focus:outline-none text-sm leading-6 py-2 mb-2 ring-1 ring-gray-200");
    			attr_dev(input, "id", /*id*/ ctx[1]);
    			attr_dev(input, "placeholder", /*placeholder*/ ctx[2]);
    			add_location(input, file$2, 9, 0, 137);
    			add_location(br, file$2, 11, 0, 325);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					action_destroyer(/*setType*/ ctx[3].call(null, input)),
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	let { type, id, placeholder, value } = $$props;

    	function setType(node) {
    		node.type = type;
    	}

    	const writable_props = ['type', 'id', 'placeholder', 'value'];
    	...
    	$$self.$capture_state = () => ({ type, id, placeholder, value, setType });
    	...
    	return [value, id, placeholder, setType, type, input_input_handler];
    }

    class Input extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { type: 4, id: 1, placeholder: 2, value: 0 });
    ...
    function create_fragment$3(ctx) {
    	...
    	let current;
    	let if_block0 = /*selectedLink*/ ctx[0] == "" && create_if_block_1$1(ctx);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file, 95, 16, 2965);
    			attr_dev(label0, "class", "label");
    			add_location(label0, file, 94, 12, 2926);
    			attr_dev(span1, "class", "label-text text-black");
    			add_location(span1, file, 101, 28, 3295);
    			attr_dev(label1, "class", "label");
    			add_location(label1, file, 100, 24, 3244);
    			...
    			add_location(input0, file, 103, 24, 3403);
    			attr_dev(span2, "class", "label-text text-red-600");
    			add_location(span2, file, 112, 28, 3852);
    			attr_dev(label2, "class", "label");
    			add_location(label2, file, 111, 24, 3801);
    			attr_dev(div0, "class", "form-control");
    			add_location(div0, file, 99, 20, 3192);
    			attr_dev(span3, "class", "label-text text-black");
    			add_location(span3, file, 120, 28, 4250);
    			attr_dev(label3, "class", "label");
    			add_location(label3, file, 119, 24, 4199);
    			...
    			add_location(input1, file, 122, 24, 4361);
    			attr_dev(span4, "class", "label-text text-red-600");
    			add_location(span4, file, 131, 28, 4818);
    			attr_dev(label4, "class", "label");
    			add_location(label4, file, 130, 24, 4767);
    			attr_dev(div1, "class", "form-control");
    			add_location(div1, file, 118, 20, 4147);
    			add_location(br, file, 136, 20, 5038);
    			attr_dev(span5, "class", "label-text text-red-600");
    			add_location(span5, file, 139, 24, 5191);
    			attr_dev(label5, "class", "label");
    			add_location(label5, file, 138, 20, 5144);
    			...
    			attr_dev(button, "href", "pages/authentication/login");
    			add_location(button, file, 142, 24, 5349);
    			attr_dev(div2, "class", "form-control");
    			add_location(div2, file, 141, 20, 5297);
    			attr_dev(form_1, "id", "main");
    			add_location(form_1, file, 97, 16, 3076);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "text-gray-900 placeholder-gray-400 absolute");
    			add_location(div0, file, 163, 6, 6313);
    			attr_dev(div1, "class", "flex justify-center");
    			add_location(div1, file, 162, 4, 6272);
    			...
    			add_location(button, file, 170, 6, 6605);
    			attr_dev(div2, "class", "flex flex-col justify-between");
    			add_location(div2, file, 169, 4, 6554);
    			...
    			add_location(div3, file, 161, 0, 6126);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", prevent_default(/*submit*/ ctx[5]), false, true, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*fields, data*/ 20) {
    				each_value = /*fields*/ ctx[4];
    				validate_each_argument(each_value);
    				let i;
    ...
    // (165:10) {#each fields as {type, id, placeholder, bound}}
    function create_each_block(ctx) {
    	...
    	function input_value_binding(value) {
    		/*input_value_binding*/ ctx[8](value, /*bound*/ ctx[16]);
    	}
    	...
    	if (/*data*/ ctx[2][/*bound*/ ctx[16]] !== void 0) {
    		input_props.value = /*data*/ ctx[2][/*bound*/ ctx[16]];
    	}
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (!updating_value && dirty & /*data, fields*/ 20) {
    				updating_value = true;
    				input_changes.value = /*data*/ ctx[2][/*bound*/ ctx[16]];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(165:10) {#each fields as {type, id, placeholder, bound}}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if_block1.c();
    			if_block1_anchor = empty();
    			add_location(h1, file, 88, 8, 2701);
    			add_location(br, file, 88, 36, 2729);
    			attr_dev(div0, "class", "justify-end card-body align:center");
    			add_location(div0, file, 91, 8, 2819);
    			attr_dev(div1, "class", "card shadow-xl image-full");
    			add_location(div1, file, 86, 4, 2586);
    			attr_dev(div2, "class", "p-3");
    			add_location(div2, file, 85, 0, 2563);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	function input_value_binding(value, bound) {
    		if ($$self.$$.not_equal(data[bound], value)) {
    			data[bound] = value;
    			$$invalidate(2, data);
    		}
    	}
